...
export default function App() {
  ...
  if (loading) {
    ...
    <div role="status">
        <svg aria-hidden="true" className="inline w-10 h-10 w-8 h-8 text-neutral-tertiary animate-spin fill-purple" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
