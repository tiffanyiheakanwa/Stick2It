            ...
            todayReminders.map((task) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div
                    className={`flex flex-wrap items-center gap-2 mb-1 ${task.completed ? "line-through text-gray-400" : ""}`}
                  >
                ...
                <Badge
                  className={`${priorityColors[task.priority as keyof typeof priorityColors]} flex-shrink-0`}
                >
                  {task.priority}
                </Badge>
              </div>
